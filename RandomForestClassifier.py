...
# - Random forest classifier uses training data to create mutliple datasets using **"Boot Strapping"** Method.
# - Majority vote is the final predicted class
# - we select the records randomly and we create a decision tree for each dataset
# - the  which the maximum no of then it is selected as predicted class
