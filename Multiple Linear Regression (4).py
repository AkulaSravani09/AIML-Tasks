...
# #### Identification of High Infulence points(spatial outliers)
...
#Discard the data points which are influencers and reassign the row number(rest_index
...
# ### Build model3 on cars2 datasert
...
# ###  Homework (sample code is avaiable in simple linear regression)
# - q-q plot for (model3.resdi)
# - scatterplot for (y-y^) vs Homoscedasticity
